 ...
 */
final class Version20240322230122 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE competence (id INT AUTO_INCREMENT NOT NULL, id_matiere_id INT DEFAULT NULL, statut INT NOT NULL, sous_matiere VARCHAR(255) DEFAULT NULL, INDEX IDX_94D4687F51E6528F (id_matiere_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE niveau (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(255) NOT NULL, code INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE soutien (id INT AUTO_INCREMENT NOT NULL, demande_id INT NOT NULL, date_du_soutien DATE NOT NULL, date_update DATE NOT NULL, description VARCHAR(255) DEFAULT NULL, status INT NOT NULL, UNIQUE INDEX UNIQ_99A7D32180E95E18 (demande_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
